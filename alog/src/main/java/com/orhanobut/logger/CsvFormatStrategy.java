...
public class CsvFormatStrategy implements FormatStrategy {
  ...
  @Override public void log(int priority, @Nullable String onceOnlyTag, @NonNull String message) {
    ...
    //builder.append(Long.toString(date.getTime()));//不需要显示时间戳
    ...
    // level
    builder.append(SEPARATOR);
    builder.append(Utils.logLevelToAbbreviation(priority));
  ...
  public static final class Builder {
    ...
    @Nullable private String folder;
    ...
    @NonNull public Builder folder(String folder) {
      this.folder = folder;
      return this;
    }
